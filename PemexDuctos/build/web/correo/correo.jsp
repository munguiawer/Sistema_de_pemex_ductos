            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title"><i class="fa fa-envelope-o"></i> Crea un nuevo mensaje</h4>
                    </div>
                    <form action="#" method="post">
                        ...
                        <div class="modal-footer clearfix">
                            ...
                            <button type="submit" class="btn btn-primary pull-left"><i class="fa fa-envelope"></i> Enviar Mensage</button>
                        </div>
                    </form>
                </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
