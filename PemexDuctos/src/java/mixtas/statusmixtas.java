 ...
 * @author jose_l
 */
public final class statusmixtas {
    ...
    public statusmixtas(String responsable, String fecha) throws SQLException {
        ...
        String sql = "SELECT PemexQBs.mixtasordenes.Orden,PemexQBs.mixtasordenes.Cost_total_real,PemexQBs.mixtasordenes.Total_coste_plan, PemexQBs.mixtasordenes.Texto_breve,PemexQBs.mixtasordenes.pto_trab_res,pemexqbs.mixtasordenes.Total_coste_plan,PemexQBs.mixtasordenes.grupo_plan_mant,PemexQBs.mixtasordenes.Estado\n"
                ...
                + "where pemexqbs.mixtasordenes.pto_trab_res = '" + responsable + "' and  pemexqbs.mixtasordenes.fecha_fin_extr < '" + fecha + "'  \n"
                + "GROUP BY 1;";
        ...
        while (datos.getResultSet().next()) {
            ...
            if((datos.getResultSet().getFloat("Total_coste_plan")*.20) < (datos.getResultSet().getFloat("Total_coste_plan") - datos.getResultSet().getFloat("Cost_total_real")) )
            {
                 Error.add(datos.getResultSet().getString("Orden"));
    ...
    public statusmixtas(String responsable) throws SQLException {
    ...
    public Timestamp getHoraphoto() {
        return horaphoto;
    }

    public ArrayList<String> getErrorestatus() {
        return Errorestatus;
    }

    public ArrayList<String> getErrorCosto20() {
        return ErrorCosto20;
    }

    public ArrayList<String> getErrorTextobrev() {
        return ErrorTextobrev;
    }

    public ArrayList<String> getErrorsinAvisoA1() {
        return ErrorsinAvisoA1;
    }

    public ArrayList<String> getErrorGrup() {
        return ErrorGrup;
    }

    public ArrayList<String> getErrorCero() {
        return ErrorCero;
    }

    public ArrayList<String> getErrorIncum() {
        return ErrorIncum;
    }
