...
/**
 * The persistent class for the valvschm database table.
 * 
 */
@Entity
@NamedQuery(name="Valvschm.findAll", query="SELECT v FROM Valvschm v")
public class Valvschm implements Serializable {
