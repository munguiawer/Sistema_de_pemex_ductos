...
--
-- Table structure for table `proyectos2`
--
...
CREATE TABLE `proyectos2` (
  ...
  CONSTRAINT `fk_Proyectos_2` FOREIGN KEY (`PtoTrbRes`) REFERENCES `areas` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `proyectos2`
--

LOCK TABLES `proyectos2` WRITE;
/*!40000 ALTER TABLE `proyectos2` DISABLE KEYS */;
/*!40000 ALTER TABLE `proyectos2` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-25  1:33:40
