...
--
-- Table structure for table `ermpdf`
--

DROP TABLE IF EXISTS `ermpdf`;
...
--
-- Dumping data for table `ermpdf`
--

LOCK TABLES `ermpdf` WRITE;
/*!40000 ALTER TABLE `ermpdf` DISABLE KEYS */;
INSERT INTO `ermpdf` VALUES (2,'ENERO','servidorcsvredes.pdf','ERMS/ENERO/servidorcsvredes.pdf','506343',2015,1);
/*!40000 ALTER TABLE `ermpdf` ENABLE KEYS */;
UNLOCK TABLES;
